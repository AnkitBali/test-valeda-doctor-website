<%@ Page Language="C#" AutoEventWireup="true" CodeFile="crm_querySuccess.aspx.cs" Inherits="crm_querySuccess" %>
                ...
                <div class="container">
                    <div class="row">
                        ...
                        <div class="wt-topbar-right clearfix">
                           ...
                           <li><a href="https://www.youtube.com/channel/UCkJ2dy7qWrXKxbGBi4g-mHw" target="_blank" class="fa fa-youtube"></a></li>                           
                        ...
                        <button data-target=".header-nav" data-toggle="collapse" type="button" class="navbar-toggle collapsed">
                         ...
                         <div class="header-nav navbar-collapse collapse ">
                            <ul class=" nav navbar-nav">
                                ...
                                <li><a href="folliculitis.html"> <i class="fa fa-angle-double-right"></i> Folliculatis</a></li>
...
<ul class="sub-menu">
                                       ...
                                       <li><a href="electrolysis.html">Electrolysis</a></li>
                                        <li><a href="https://www.fda.gov/ForConsumers/ConsumerUpdates/ucm048995.htm" target="_blank">Read what US FDA says on LASER</a></li>
                                ...
                                <li style="text-align:center"><a href="contact-us.html" style="padding:0px !important;"><button class="header-button graphical pink m-r15" type="button">Contact Us</button></a> </li>
                            </ul>
	         ...
	         <form id="queryForm" runat ="server"   >
                         ...
                         <div class="row">
                          ...
                          <div class="col-md-6">
                             ...
                             <asp:Label ID="lblMess" Font-Bold="true" ForeColor ="Red"  runat="server" ></asp:Label>
                        </div>
                        </div>
                        </div>
                        </div>
...
box-shadow:0px 5px 10px #000;"><strong style=" font-size:15px; text-shadow: 5px 5px 7px #000;">For Telephonic Consultation<br> with Specialist Doctors<br> Please Pay <strong>Rs. 500/-</strong> <br>and Submit this Form</strong></button></a>
                          ...
                          <div class="col-md-4 col-sm-6">
                            <div class="widget widget_services">
                                ...
                                <div class="icon-content">
                                   ...
                                   <p><span style="color:#000"> Valeda Wellness GF, W-1,<br>Greater Kailash-1, <br>New Delhi 110048.</span></p></div>
                                   ...
                                   <strong> Phone No.:</strong> 011 43175750 </span></p></div>
                                   
                                     <div class="col-lg-4 m-t10">
                                   <p style="color:#5B3F4A"><i class="fa fa-envelope "></i> <strong> Email-Id:</strong></p>
                                   </div>
                                   <div class="col-lg-8">
                                   <span style="color:#000">info@valedadoctor.com<br>
